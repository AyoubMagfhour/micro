...
public class UserController {
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long userId) {
        try {
            ...
            // Handle the exception and return the appropriate HTTP status
    ...
    @PutMapping("/userprofilupdate/{userId}")
    public ResponseEntity<User> updatePassword2(@PathVariable Long userId, @RequestBody User updatedUser) {
